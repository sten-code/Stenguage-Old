...
namespace Editor
{
    public class HighlighterManager
    {
        ...
        private IDictionary<string, IHighlighter> GetInternalResources()
        {
            ...
            var gfdgd = Application.GetResourceStream(new Uri("/Editor;component/Resources/syntax.xsd", UriKind.Relative));
        ...
        {
            var gfdgd = Application.GetResourceStream(new Uri("pack://application:,,,/Editor;component/Resources/syntax.xsd"));
            var schemaStream = gfdgd.Stream;
